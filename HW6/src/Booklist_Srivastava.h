...
template <class T>
void Booklist<T>::insert(T new_element)
{
...
template <class T>
void Booklist<T>::insert_at(int at_position, T new_element)
{
...
template <class T>
int  Booklist<T>::find_linear(T element)
{
	int position = -1;
...
template <class T>
int  Booklist<T>::find_binary(T element)
{
	int position = -1;
...
template <class T>
void Booklist<T>::delete_item_isbn(T element)
{
	if(num_in_list == 0)
	{
		std::cout << "Error - book list is empty" << std::endl;
...
template class Booklist<int>;
template class Booklist<std::string>;
